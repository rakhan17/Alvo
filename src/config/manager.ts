...
import os from 'os';
import { PersonaConfigSchema, ValidatedPersonaConfig } from './schema.js';
...
export class ConfigManager {
  ...
  private currentConfig: ValidatedPersonaConfig;
  ...
  public getConfig(): ValidatedPersonaConfig {
    return this.currentConfig;
  }

  public loadConfig(): ValidatedPersonaConfig {
    ...
    if (process.env.ALVO_PROVIDER) {
      merged.provider = process.env.ALVO_PROVIDER as any;
    }
  ...
  public saveConfig(newConfig: Partial<ValidatedPersonaConfig>, isGlobal = false): ValidatedPersonaConfig {
  ...
  public applyPreset(presetName: string): ValidatedPersonaConfig {
    ...
    return this.saveConfig({ ...preset, relationship: presetName as any });
  }
}
