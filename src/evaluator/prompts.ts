...
export function buildProactiveSystemPrompt(config: ValidatedPersonaConfig): string {
...
export function buildProactiveUserPrompt(snapshot: SystemSnapshot, recentMessagesSummary?: string): string {
...
export function buildChatSystemPrompt(config: ValidatedPersonaConfig, currentSnapshot?: SystemSnapshot | null): string {
